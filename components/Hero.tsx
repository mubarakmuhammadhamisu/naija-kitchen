...
export default function Hero() {
  ...
  useEffect(() => {
    ...
    const targets = el.querySelectorAll<HTMLElement>(".hero-animate");
    targets.forEach((t, i) => {
      setTimeout(() => {
        t.style.opacity = "1";
  ...
  return (
    ...
    >
      {/* Ambient glow blobs */}
      <div className="glow-blob w-[600px] h-[600px] bg-naija-red/8 -top-40 -left-60" />
      <div className="glow-blob w-[500px] h-[500px] bg-naija-amber/6 top-1/2 -right-40" />
      ...
      {/* Decorative right-side gradient bleed */}
      <div className="absolute inset-y-0 right-0 w-1/2 bg-gradient-to-l from-naija-amber/5 via-transparent to-transparent pointer-events-none" />
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-12 lg:pt-28 lg:pb-16 w-full">
        <div className="grid lg:grid-cols-2 gap-10 lg:gap-6 items-center">
          ...
          <div className="flex flex-col gap-6 max-w-xl">
            ...
            >
              <span className="w-8 h-[2px] bg-naija-red rounded-full" />
            ...
            >
              <h1 className="font-syne font-800 text-5xl sm:text-6xl lg:text-7xl leading-[1.05] tracking-tight">
                <span className="text-white block">Bold Flavors.</span>
                <span className="text-gradient-amber block mt-1">
                  True Naija.
                </span>
              </h1>
            </div>
            ...
            >
              ...
              <div className="flex items-center gap-2">
                <div className="flex -space-x-2.5">
                  {AVATAR_URLS.map((src, i) => (
                    <div
                      key={i}
                      className="w-9 h-9 rounded-full border-2 border-naija-dark overflow-hidden"
                    >
                      <Image
                        src={src}
                        alt={`Customer ${i + 1}`}
                ...
                <div className="flex flex-col">
                  <span className="text-white text-xs font-outfit font-600">
                  ...
                  <div className="flex items-center gap-1">
                    ...
                    <span className="text-white/50 text-[11px] ml-0.5">
                      4.9 (250+ Reviews)
                    </span>
                  </div>
                </div>
              ...
              {/* Open Now Badge */}
              <div className="flex items-center gap-2 bg-naija-card border border-naija-border rounded-full px-4 py-2">
                <span className="w-2.5 h-2.5 rounded-full bg-green-400 open-pulse block" />
                <div className="flex flex-col leading-none">
                  <span className="text-white text-xs font-syne font-700">
                    Open Now
                  </span>
                  <span className="text-white/40 text-[10px] font-outfit">
                    Closes at 11:00 PM
                  </span>
                </div>
              </div>
          ...
          <div className="relative flex items-center justify-center lg:justify-end">
            {/* Background amber circle glow */}
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="w-[420px] h-[420px] rounded-full bg-naija-amber/10 blur-3xl" />
            </div>

            {/* Decorative ring */}
            <div className="absolute w-[480px] h-[480px] rounded-full border border-naija-amber/10" />
            <div className="absolute w-[380px] h-[380px] rounded-full border border-naija-red/10" />
            ...
            <div className="relative z-10 hero-float">
              <div className="relative w-[340px] h-[340px] sm:w-[400px] sm:h-[400px] lg:w-[460px] lg:h-[460px]">
                <Image
                  ...
                  alt="Naija Kitchen signature jollof rice with grilled chicken"
                  fill
                  className="object-cover rounded-full"
                  priority
                />
                {/* Radial gradient overlay for circular fade */}
                <div className="absolute inset-0 rounded-full bg-radial-gradient"
                  style={{
                    background:
                      "radial-gradient(ellipse at center, transparent 50%, #0A0A0A 85%)",
                  }}
                />
              </div>
            </div>

            {/* Floating badge: 100% Nigerian */}
            <div className="absolute top-8 right-4 lg:right-0 z-20 bg-naija-card border border-naija-border rounded-full w-20 h-20 flex flex-col items-center justify-center shadow-xl">
              <span className="text-naija-amber font-syne font-800 text-lg leading-none">
                100%
              </span>
            ...
            <div className="absolute bottom-12 right-2 lg:right-0 z-20 w-24 h-24 rounded-2xl overflow-hidden border-2 border-naija-amber/30 shadow-xl">
              <Image
                ...
                alt="Naija Kitchen restaurant interior"
                width={96}
                height={96}
                className="object-cover w-full h-full"
              />
        ...
        {/* Scroll Down */}
        <div className="flex flex-col items-center gap-2 mt-10 lg:mt-14">
          <span className="text-white/30 text-xs font-outfit tracking-wider uppercase">
            Scroll Down
          </span>
