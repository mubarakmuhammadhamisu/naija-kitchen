...
const DISHES: Dish[] = [
  {
    ...
    tag: "Best Seller",
    rating: 4.9,
    img: "https://images.unsplash.com/photo-1604329760661-e71dc83f8f26?auto=format&fit=crop&w=500&q=80",
  },
  {
    name: "Suya Platter",
    desc: "Spicy grilled beef suya with onions & sauce.",
    price: "₦3,800",
    tag: "Popular",
    rating: 4.8,
    img: "https://images.unsplash.com/photo-1529563021893-cc83c992d75d?auto=format&fit=crop&w=500&q=80",
  },
  {
    name: "Ofada Rice & Ayamase",
    desc: "Local brown rice with designer stew.",
    price: "₦4,200",
    tag: "Chef's Pick",
    rating: 4.9,
  ...
  {
    name: "Pepper Soup",
    desc: "Spicy goat meat pepper soup to warm your soul.",
    price: "₦3,200",
    rating: 4.7,
  ...
  {
    name: "Efo Riro",
    desc: "Sautéed spinach with assorted meat/fish.",
    price: "₦4,000",
    rating: 4.8,
  ...
  {
    name: "Egusi Soup & Eba",
    desc: "Rich melon seed soup with golden eba.",
    price: "₦3,600",
    tag: "Traditional",
    rating: 4.9,
...
export default function Bestsellers() {
      ...
      (entries) => {
        entries.forEach((entry) => {
          if (entry.isIntersecting) {
            entry.target
              .querySelectorAll<HTMLElement>(".bs-animate")
              .forEach((el, i) => {
                setTimeout(() => {
                  el.style.opacity = "1";
  ...
  return (
    <section id="menu" className="relative bg-naija-dark py-20 lg:py-28 overflow-hidden">
      <div className="glow-blob w-[400px] h-[400px] bg-naija-amber/5 top-0 right-0" />
        ...
        <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-6 mb-12">
          ...
          >
            <div className="flex items-center gap-2">
              <span className="w-6 h-[2px] bg-naija-amber rounded-full" />
              <span className="text-naija-amber text-xs font-syne font-700 tracking-[0.2em] uppercase">
                Chef&apos;s Specials
              </span>
            </div>
            <h2 className="font-syne font-800 text-4xl sm:text-5xl text-white leading-tight tracking-tight">
            ...
            <div className="flex items-center gap-1">
              {[...Array(5)].map((_, i) => (
                <div
                  key={i}
                  className="w-4 h-1 bg-naija-red/50 rounded-full"
...
function DishCard({ dish, index }: { dish: Dish; index: number }) {
  ...
  return (
    <div
      className="dish-card group shrink-0 w-[280px] bg-naija-card border border-naija-border rounded-2xl overflow-hidden card-hover"
      style={{
    ...
    >
      ...
      <div className="relative h-44 overflow-hidden">
        ...
        />
        <div className="absolute inset-0 bg-gradient-to-t from-naija-card via-transparent to-transparent" />
      ...
      <div className="p-5 flex flex-col gap-3">
        <div>
          ...
          <p className="text-white/50 text-xs font-outfit mt-1 leading-relaxed">
            {dish.desc}
          </p>
        </div>

        <div className="flex items-center justify-between">
          <span className="font-syne font-800 text-naija-amber text-lg">
            {dish.price}
          </span>
          <div className="flex items-center gap-1">
            <Star size={12} className="text-naija-amber fill-naija-amber" />
